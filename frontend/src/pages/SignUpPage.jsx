...
const SignUpPage = () => {
  ...
  const {mutate: signupMutation, isPending, error} = useMutation({
    ...
    success: true,
    data: { user: data.data }  // ✅ wraps it just like /auth/me
});
  },
  onError: (err) => {
      ...
      <div className="border border-primary/25 flex flex-col lg:flex-row w-full max-w-5xl mx-auto bg-base-100 rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 p-4 sm:p-8 flex flex-col">
          ...
          <div className="mb-4 flex items-center justify-start gap-2">
            ...
            <span className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary font-[perrgot] tracking-wider">
                  Murmur
                </span>
          </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm opacity-70">
                    Join Murmur and start your journey today
                  </p>
                </div>
        ...
        <div className="hidden lg:flex w-full lg:w-1/2 bg-primary/10 items-center justify-center">
          <div className="max-w-md p-8">
            ...
            <div className="relative aspect-square max-w-sm mx-auto">
              <img src="/Fear-amico.png" alt="Language connection illustration" className="w-full h-full" />
            </div>
